...
from utils_mix import (
    ...
    strong_aug_bert_shuffle, strong_aug_gat_dropedge, print_pseudo_evaluation
)
...
def main():
    ...
    for alpha_step in range(3, 4):
        ...
        for epoch in range(1, EPOCHS + 1):
            ...
            # === Evaluate pseudo-label quality on validation set ===
            if len(val_indices) > 0:
                val_pseudo = generate_pseudo_from_fusion(
                ...
                print_pseudo_evaluation(val_pseudo, global_labels)
