...
# 配置（你只需修改这几项）
# ======================================================
JSON_DIR = r"D:\project\data\CED_Dataset\original-microblog"
LABEL_PATH = r"D:\project\data\CED_Dataset\train_label.csv"  # 用于定位目录即可
...
MODEL_SAVE_PATH = r"D:\project\data\CED_Dataset\bert_final.pt"
...
# 模型 / 优化器
# ======================================================
net = model(r"D:/bert-base-chinese", num_classes=2).to(DEVICE)
